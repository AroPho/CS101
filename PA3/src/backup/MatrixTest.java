...
public class MatrixClient{
   public static void main(String[] args){
      ...
      A = new Matrix(10);
        ...
        A.changeEntry(2, 3, 0);
        A.changeEntry(3, 3, 5);
        if (A.getNNZ() != 7) System.out.println(1);
        A.changeEntry(1, 3, 0);
        A.changeEntry(3, 1, 0);
        A.changeEntry(3, 3, 0);
        if (A.getNNZ() != 4) System.out.println(2);
        A.changeEntry(7, 6, 42);
        A.changeEntry(10, 1, 24);
        if (A.getNNZ() != 6) System.out.println(3);
        A.changeEntry(7, 6, 0);
        if (A.getNNZ() != 5) System.out.println(4);
        A.makeZero();
        A.changeEntry(5, 5, 5);
        if (A.getNNZ() != 1) System.out.println(5);
   }
}
